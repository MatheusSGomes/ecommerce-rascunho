...
{
    /// <inheritdoc />
    public partial class ColaboradoresSetores : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataRegistroCriado = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "ColaboradorId", "SetorId", "DataRegistroCriado" },
                values: new object[,]
                {
                    { 1, 1, new DateTimeOffset(new DateTime(2024, 9, 9, 11, 37, 35, 886, DateTimeKind.Unspecified).AddTicks(4405), new TimeSpan(0, -3, 0, 0, 0)) },
                    { 2, 1, new DateTimeOffset(new DateTime(2024, 9, 9, 11, 37, 35, 886, DateTimeKind.Unspecified).AddTicks(4457), new TimeSpan(0, -3, 0, 0, 0)) },
                    { 3, 2, new DateTimeOffset(new DateTime(2024, 9, 9, 11, 37, 35, 886, DateTimeKind.Unspecified).AddTicks(4461), new TimeSpan(0, -3, 0, 0, 0)) },
                    { 4, 2, new DateTimeOffset(new DateTime(2024, 9, 9, 11, 37, 35, 886, DateTimeKind.Unspecified).AddTicks(4464), new TimeSpan(0, -3, 0, 0, 0)) },
                    { 5, 3, new DateTimeOffset(new DateTime(2024, 9, 9, 11, 37, 35, 886, DateTimeKind.Unspecified).AddTicks(4467), new TimeSpan(0, -3, 0, 0, 0)) },
                    { 6, 3, new DateTimeOffset(new DateTime(2024, 9, 9, 11, 37, 35, 886, DateTimeKind.Unspecified).AddTicks(4469), new TimeSpan(0, -3, 0, 0, 0)) }
                });
